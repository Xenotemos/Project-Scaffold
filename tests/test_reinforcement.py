...
from brain.reinforcement import score_response, reset_outward_streak
...
class ReinforcementScoringTests(unittest.TestCase):
    def test_authenticity_detection(self) -> None:
        ...
        scores = score_response(user, reply)
    ...
    def test_outward_streak_increases_with_consecutive_hits(self) -> None:
        ...
        first_scores = score_response(user, reply_one)
        second_scores = score_response(user, reply_two)
